...
export default function AddMoney() {
  ...
  return (
    <div className="d-flex flex-column" style={{ minHeight: "100vh", background: "#fff" }}>
      {/* Header */}
      ...
      <div className="text-center my-4">
        ...
        <div style={{ fontSize: "16px", color: "#666" }}>Enter amount to add</div>
        <h2 className="fw-bold mt-2">₹{amount}</h2>
        <p className="text-muted">You can add a maximum of ₹1,00,000 in this month</p>
      ...
      <div className="px-3 mt-3 text-muted small">
        <p>• Blinkit Money balance is valid for 1 year from the date of money added</p>
        <p>• Blinkit Money is useable on Blinkit and Bistro</p>
        <p>• Blinkit Money cannot be transferred to a bank account as per RBI guidelines</p>
      </div>

      {/* Bottom Fixed Add Money Bar */}
      <div
